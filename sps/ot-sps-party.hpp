...
#include "Math/gfp.h"
#include "sps/P256Element.h"


#include "Protocols/SemiShare.h"
#include "Processor/BaseMachine.h"

#include "sps/preprocessing.hpp"
#include "sps/sign.hpp"
...
void run(int argc, const char** argv)
{
    ...
    vector<PCISPSInput> pciinputs;
    vector<PCISPSInput> generatedinputsA;
    vector<PCISPSInput> generatedinputsB;
    ClearInput<PCISPSInput> clearInput(P);
    ...
    if (P.my_num() == 0){
        ...
        // free unused vector
        vector<PCISPSInput>().swap(generatedinputsA);
        ...
        // free unused vector
        vector<PCISPSInput>().swap(generatedinputsB);
    ...
    vector<PCISPSInput>().swap(pciinputs);
